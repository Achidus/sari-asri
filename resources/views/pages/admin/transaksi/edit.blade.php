...
<div class="d-flex justify-content-between align-items-center pt-2 pb-4 flex-wrap">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="kode_transaksi" value="{{ $transaksi->kode_transaksi }}" readonly>
...
<div class="row">
            ...
            <select name="nasabah_id" class="form-control select2" required>
                ...
                @foreach ($nasabahList as $nasabah)
                    <option value="{{ $nasabah->id }}"
                        {{ $nasabah->id == $transaksi->nasabah_id ? 'selected' : '' }}>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-bordered" id="setoran-details">
                                <thead>
                                    <tr>
                                        <th>Jenis Sampah</th>
                                        <th>Berat (kg)</th>
    ...
    <tr>
        <td>
            <select name="detail_transaksi[{{ $index }}][sampah_id]" class="form-control" required>
        ...
        <td><input type="number" name="detail_transaksi[{{ $index }}][berat_kg]" value="{{ $detail->berat_kg }}" class="form-control berat-kg" required></td>
        <td><input type="number" name="detail_transaksi[{{ $index }}][harga_per_kg]" value="{{ $detail->harga_per_kg }}" class="form-control harga-per-kg" readonly required></td>
        <td class="total-harga">{{ $detail->harga_total }}</td>
