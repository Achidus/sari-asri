                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row row-cols-2 g-1">
                                                ...
                                                <div class="col">
                                                    <a href="{{ route('admin.transaksi.edit', $transaksi->id) }}" class="btn btn-sm btn-primary w-100">
                                                        <i class="fas fa-pencil-alt"></i> Edit
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <a href="{{ route('admin.transaksi.print', $transaksi->id) }}" class="btn btn-sm btn-secondary w-100">
